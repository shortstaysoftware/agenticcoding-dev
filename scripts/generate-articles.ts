            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-8">
                        ...
                        <a href="../index.html#newsletter" class="bg-brand-600 hover:bg-brand-500 text-white px-4 py-2 rounded-md text-sm font-bold shadow-lg shadow-brand-500/20 transition-all">Subscribe</a>
                    </div>
                </div>
            </div>
        </div>
